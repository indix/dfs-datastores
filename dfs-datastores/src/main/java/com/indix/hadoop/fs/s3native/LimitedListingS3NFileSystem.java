 ...
 * </p>
 * <h1>MODIFICATIONS</h1>
 * <p>This is a copy of NativeS3FileSystem implementation, with just modifications to listStatus()
 ...
 * goes out of memory because of the sheer number of objects it has to keep. We anyways discard these
 * in the job and retain only a <code>maxNumberOfFiles</code> files.
 * </p>
 *
...
public class LimitedListingS3NFileSystem extends FileSystem {
    ...
    public FileStatus[] listStatus(Path f) throws IOException {
        ...
        String priorLastKey = null;
        do {
            LOG.debug("Fetching maximum of " + S3_MAX_LISTING_LENGTH + " keys from S3. Last known key was " + priorLastKey);
